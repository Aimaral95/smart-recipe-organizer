...
// Put your keys in .env.local (gitignored) — never commit them.
// dangerouslyAllowBrowser: true is fine for local dev only. Before we deploy
// to Vercel on Day 7 we'll move the API call behind a serverless function.
